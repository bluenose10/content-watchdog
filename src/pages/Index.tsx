  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="section-padding container px-4 md:px-8 lg:px-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-center">Comprehensive Content Protection</h2>
          ...
          <div className="grid grid-cols-1 gap-8 mb-16 md:mb-24">
          ...
          <div className="mb-16 md:mb-24" id="about">
            <AboutSection />
          </div>
          ...
          {/* Pricing section */}
          <div className="mb-16 md:mb-24" id="pricing">
            <PricingSection />
          </div>
          ...
          {/* FAQ section */}
          <div className="mb-16 md:mb-24" id="faq">
            <FAQSection />
          </div>
        </div>
      </main>
