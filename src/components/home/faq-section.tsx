      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
            ...
            <AccordionItem value="item-2" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
              <AccordionTrigger className="text-lg font-medium py-5 hover:no-underline">
            ...
            <AccordionItem value="item-3" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
              <AccordionTrigger className="text-lg font-medium py-5 hover:no-underline">
            ...
            <AccordionItem value="item-4" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
              <AccordionTrigger className="text-lg font-medium py-5 hover:no-underline">
            ...
            <AccordionItem value="item-5" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
              <AccordionTrigger className="text-lg font-medium py-5 hover:no-underline">
            ...
            <AccordionItem value="item-6" className="bg-white dark:bg-gray-800 rounded-xl px-6 shadow-sm border border-purple-100/50 dark:border-purple-900/30">
              <AccordionTrigger className="text-lg font-medium py-5 hover:no-underline">
