...
export function CallToAction() {
  return (
    <section className="h-full">
      <div className="h-full flex flex-col justify-center items-center bg-primary text-primary-foreground rounded-xl p-5">
        <h2 className="text-xl font-bold mb-3 text-center">Ready to Start?</h2>
