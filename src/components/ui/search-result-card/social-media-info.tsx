...
import { Facebook, Instagram, Linkedin, Twitter, Youtube, Video, Image, FileText, Globe } from "lucide-react";
...
export function getSocialMediaInfo(cleanSource: string, validType: string): SocialMediaInfo {
  try {
